...
class FisrolController extends Controller
{
    // Tampilkan form ambil foto dan input
    public function form()
    {
        return view('fisrol.foto_form');
    }
    ...
    public function hasil(Request $request)
    {
        ...
        return view('fisrol.foto_hasil', compact('foto', 'teks'));
    }
    ...
    public function unduhPpt(Request $request)
    {
        ...
        $textShape->setHeight(100)
            ...
            ->setOffsetX(350)
            ->setOffsetY(20);
        $textRun = $textShape->createTextRun("Hasil Temuan 5S");
        $textRun->getFont()->setBold(true)->setSize(20)->setColor(new Color('FF000000'));
        $slide->addShape($textShape);

        // Output PPT
        $filename = 'temuan_5s.pptx';
